...
public class JobController {
    ...
    public JobController(JobService jobService, SkillService skillService, BenefitService benefitService, LevelService levelService, UserService userService, JobExcelImporterService jobExcelImporterService) {
...
//            return "redirect:/jobs/manager/list/" + managerId;
    ...
    public String listJobForInterview(
        ...
        model.addAttribute("title", title);
        model.addAttribute("status", status);
        return "Jobs/interview/jobs-interview";
    }
}
